...
# source://sinatra-contrib//lib/sinatra/contrib/version.rb#1
module Sinatra
  class << self
...
module Sinatra::Capture
  ...
  # source://sinatra-contrib//lib/sinatra/capture.rb#104
...
#
# source://sinatra-contrib//lib/sinatra/config_file.rb#109
module Sinatra::ConfigFile
  ...
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#120
  ...
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#150
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#170
  def environment_keys?(hash); end

  # Given a +hash+ returns the settings corresponding to the current
  # environment.
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#164
  ...
  class << self
    ...
    #
    # source://sinatra-contrib//lib/sinatra/config_file.rb#113
    def registered(base); end
  end
end

# source://sinatra-contrib//lib/sinatra/config_file.rb#139
class Sinatra::ConfigFile::UnsupportedConfigType < ::Exception
  # source://sinatra-contrib//lib/sinatra/config_file.rb#140
  def message; end
end
...
#     <%= yield_content :two %>
#
# source://sinatra-contrib//lib/sinatra/content_for.rb#111
module Sinatra::ContentFor
  ...
  #
  # source://sinatra-contrib//lib/sinatra/content_for.rb#154
  ...
  #
  # source://sinatra-contrib//lib/sinatra/content_for.rb#131
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/content_for.rb#147
  ...
  # for <tt>:head</tt>.
  #
  # source://sinatra-contrib//lib/sinatra/content_for.rb#175
  def yield_content(key, *args, &block); end

  private

  # source://sinatra-contrib//lib/sinatra/content_for.rb#190
  def content_blocks; end
end

# source://sinatra-contrib//lib/sinatra/contrib/version.rb#2
module Sinatra::Contrib
  extend ::Sinatra::Contrib::Loader

  class << self
    # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#47
    def registered(base); end
  end
end

# source://sinatra-contrib//lib/sinatra/contrib/setup.rb#40
module Sinatra::Contrib::All
  class << self
    # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#41
    def registered(base); end
  end
end
...
#
# source://sinatra-contrib//lib/sinatra/contrib/setup.rb#32
...
#
# source://sinatra-contrib//lib/sinatra/contrib/setup.rb#36
module Sinatra::Contrib::Custom
  extend ::Sinatra::Contrib::Loader
end

# source://sinatra-contrib//lib/sinatra/contrib/setup.rb#6
module Sinatra::Contrib::Loader
  # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#19
  def autoload(name, path, method = T.unsafe(nil)); end

  # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#7
  def extensions; end

  # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#15
  def helpers(name, path); end

  # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#11
  def register(name, path); end

  # source://sinatra-contrib//lib/sinatra/contrib/setup.rb#24
  def registered(base); end
end
...
#     end
#
# source://sinatra-contrib//lib/sinatra/cookies.rb#55
module Sinatra::Cookies
  # source://sinatra-contrib//lib/sinatra/cookies.rb#326
  def cookies; end
end

# source://sinatra-contrib//lib/sinatra/cookies.rb#56
class Sinatra::Cookies::Jar
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#79
  def ==(other); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#83
  def [](key); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#87
  def []=(key, value); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#91
  def assoc(key); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#95
  def clear; end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#109
  def delete(key); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#115
  def delete_if; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#121
  def each(&block); end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#133
  def each_value(&block); end

  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/cookies.rb#138
  def empty?; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#142
  def fetch(key, &block); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#148
  def flatten; end

  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/cookies.rb#152
  def has_key?(key); end

  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/cookies.rb#156
  def has_value?(value); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#160
  def hash; end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#167
  def index(value); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#172
  def inspect; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#176
  def invert; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#180
  def keep_if; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#185
  def key(value); end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#191
  def keys; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#195
  def length; end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#213
  def rassoc(value); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#217
  def rehash; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#223
  def reject(&block); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#115
  def reject!; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#230
  def replace(other); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#235
  def select(&block); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#180
  def select!; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#242
  def set(key, options = T.unsafe(nil)); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#246
  def shift; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#195
  def size; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#254
  def sort(&block); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#87
  def store(key, value); end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#264
  def to_a; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#260
  def to_hash; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#268
  def to_s; end
  ...
  # source://sinatra-contrib//lib/sinatra/cookies.rb#275
  def values; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#279
  def values_at(*list); end

  private

  # source://sinatra-contrib//lib/sinatra/cookies.rb#289
  def deleted; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#299
  def parse_response; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#321
  def request_cookies; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#294
  def response_cookies; end

  # source://sinatra-contrib//lib/sinatra/cookies.rb#285
...
#
# source://sinatra-contrib//lib/sinatra/engine_tracking.rb#6
module Sinatra::EngineTracking
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#112
  def initialize(*_arg0); end

  # @return [Boolean] Returns true if current engine is `:builder`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#53
  def builder?; end

  # @return [Boolean] Returns true if current engine is `:coffee`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#88
  def coffee?; end

  # @return [Boolean] Returns true if current engine is `:creole`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#103
  def creole?; end

  # Returns the value of attribute current_engine.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#7
  def current_engine; end

  # @return [Boolean] Returns true if current engine is `:erb`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#10
  def erb?; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#18
  def erubi?; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#27
  def erubis?; end

  # @return [Boolean] Returns true if current engine is `:haml`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#33
  def haml?; end

  # @return [Boolean] Returns true if current engine is `:less`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#48
  def less?; end

  # @return [Boolean] Returns true if current engine is `:liquid`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#58
  def liquid?; end

  # @return [Boolean] Returns true if current engine is `:markaby`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#83
  def markaby?; end

  # @return [Boolean] Returns true if current engine is `:markdown`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#63
  def markdown?; end

  # @return [Boolean] Returns true if current engine is `:nokogiri`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#93
  def nokogiri?; end

  # @return [Boolean] Returns true if current engine is `:radius.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#78
  def radius?; end

  # @return [Boolean] Returns true if current engine is `:rdoc`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#73
  def rdoc?; end

  # @return [Boolean] Returns true if current engine is `:ruby`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#108
  def ruby?; end

  # @return [Boolean] Returns true if current engine is `:sass`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#38
  def sass?; end

  # @return [Boolean] Returns true if current engine is `:scss`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#43
  def scss?; end

  # @return [Boolean] Returns true if current engine is `:slim`.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#98
  def slim?; end

  # @return [Boolean] Returns true if current engine is `:textile.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#68
  def textile?; end

  # @param engine [Symbol, String] Name of Engine to shift to.
  #
  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#118
  def with_engine(engine); end

  private

  # source://sinatra-contrib//lib/sinatra/engine_tracking.rb#127
...
#
# source://sinatra-contrib//lib/sinatra/extension.rb#49
module Sinatra::Extension
  # source://sinatra-contrib//lib/sinatra/extension.rb#60
  def configure(*args, &block); end

  # source://sinatra-contrib//lib/sinatra/extension.rb#64
  def registered(base = T.unsafe(nil), &block); end

  # source://sinatra-contrib//lib/sinatra/extension.rb#56
  def settings; end

  private

  # source://sinatra-contrib//lib/sinatra/extension.rb#82
  def method_missing(method, *args, &block); end

  # source://sinatra-contrib//lib/sinatra/extension.rb#70
  def record(method, *args, &block); end

  # source://sinatra-contrib//lib/sinatra/extension.rb#78
  def recorded_methods; end

  # source://sinatra-contrib//lib/sinatra/extension.rb#74
...
# source://sinatra-contrib//lib/sinatra/extension.rb#88
class Sinatra::Extension::DontCall < ::BasicObject
  # @return [DontCall] a new instance of DontCall
  #
  # source://sinatra-contrib//lib/sinatra/extension.rb#89
...
#   end
#
# source://sinatra-contrib//lib/sinatra/json.rb#89
module Sinatra::JSON
  ...
  # source://sinatra-contrib//lib/sinatra/json.rb#103
  def resolve_content_type(options = T.unsafe(nil)); end

  # source://sinatra-contrib//lib/sinatra/json.rb#107
  def resolve_encoder(options = T.unsafe(nil)); end

  # source://sinatra-contrib//lib/sinatra/json.rb#111
  def resolve_encoder_action(object, encoder); end

  class << self
    # source://sinatra-contrib//lib/sinatra/json.rb#91
...
#     end
#
# source://sinatra-contrib//lib/sinatra/link_header.rb#54
module Sinatra::LinkHeader
  ...
  #
  # source://sinatra-contrib//lib/sinatra/link_header.rb#84
  def link(*urls); end
  ...
  #   %body= yield
  #
  # source://sinatra-contrib//lib/sinatra/link_header.rb#117
  ...
  # moment).
  #
  # source://sinatra-contrib//lib/sinatra/link_header.rb#59
  def prefetch(*urls); end

  # Sets Link HTTP header and returns HTML tags for using stylesheets.
  #
  # source://sinatra-contrib//lib/sinatra/link_header.rb#65
...
#     end
#
# source://sinatra-contrib//lib/sinatra/multi_route.rb#58
module Sinatra::MultiRoute
  ...
  # source://sinatra-contrib//lib/sinatra/multi_route.rb#59
  ...
  # source://sinatra-contrib//lib/sinatra/multi_route.rb#80
...
#
# source://sinatra-contrib//lib/sinatra/namespace.rb#187
...
# source://sinatra-contrib//lib/sinatra/namespace.rb#223
module Sinatra::Namespace::NamespacedMethods
  include ::Sinatra::Namespace::SharedMethods

  # source://sinatra-contrib//lib/sinatra/namespace.rb#234
  def after(*a, &b); end

  # Returns the value of attribute base.
  #
  # source://sinatra-contrib//lib/sinatra/namespace.rb#225
  def base; end
  ...
  # source://sinatra-contrib//lib/sinatra/namespace.rb#297
  def disable(*opts); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#293
  def enable(*opts); end
  ...
  # source://sinatra-contrib//lib/sinatra/namespace.rb#239
  def helpers(*extensions, &block); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#253
  def invoke_hook(name, *args); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#306
  ...
  # source://sinatra-contrib//lib/sinatra/namespace.rb#310
  def pattern; end
  ...
  # source://sinatra-contrib//lib/sinatra/namespace.rb#244
  def register(*extensions, &block); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#281
  def respond_to(*args); end

  # @raise [ArgumentError]
  #
  # source://sinatra-contrib//lib/sinatra/namespace.rb#286
  def set(key, value = T.unsafe(nil), &block); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#301
  ...
  # source://sinatra-contrib//lib/sinatra/namespace.rb#316
  def app; end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#320
  def compile(pattern, conditions, default_pattern = T.unsafe(nil)); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#346
  def method_missing(method, *args, &block); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#338
  def prefixed(method, pattern = T.unsafe(nil), conditions = T.unsafe(nil), &block); end

  # source://sinatra-contrib//lib/sinatra/namespace.rb#331
  def prefixed_path(a, b); end

  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/namespace.rb#350
  def respond_to?(method, include_private = T.unsafe(nil)); end

  class << self
    # source://sinatra-contrib//lib/sinatra/namespace.rb#233
...
# source://sinatra-contrib//lib/sinatra/namespace.rb#217
module Sinatra::Namespace::SharedMethods
  # source://sinatra-contrib//lib/sinatra/namespace.rb#218
...
#     end
#
# source://sinatra-contrib//lib/sinatra/reloader.rb#96
module Sinatra::Reloader
  # source://sinatra-contrib//lib/sinatra/reloader.rb#217
  ...
  class << self
    ...
    # needed elements.
    #
    # source://sinatra-contrib//lib/sinatra/reloader.rb#244
    ...
    #
    # source://sinatra-contrib//lib/sinatra/reloader.rb#224
...
#
# source://sinatra-contrib//lib/sinatra/reloader.rb#256
module Sinatra::Reloader::BaseMethods
  ...
  # filter.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#305
  ...
  # error handler.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#316
  def error(*codes, &block); end

  # Does everything Sinatra::Base#register does and then registers the
  # reloader in the +subclass+.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#337
  ...
  # method.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#286
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#328
  def register(*extensions, &block); end

  # Protects Sinatra::Base.run! from being called more than once.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#258
  def run!(*args); end
  ...
  # being used.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#296
  def use(middleware, *args, &block); end
end

# Contains the methods that the extension adds to the Sinatra application.
#
# source://sinatra-contrib//lib/sinatra/reloader.rb#345
module Sinatra::Reloader::ExtensionMethods
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#368
  def also_reload(*glob); end

  # Removes the +element+ from the Sinatra application.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#347
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#374
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#381
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#394
  def registering_extension?; end

  # Indicates an extesion is being registered.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#384
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#406
  def watch_element(path, type, representation = T.unsafe(nil)); end
end

# source://sinatra-contrib//lib/sinatra/reloader.rb#213
...
class Sinatra::Reloader::Watcher
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#173
  def initialize(path); end

  # Returns the value of attribute elements.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#170
  def elements; end

  # Informs that the modifications to the file being watched
  # should be ignored.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#197
  def ignore; end
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#203
  def ignore?; end
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#191
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#208
  def removed?; end

  # Updates the mtime of the file being watched.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#185
  def update; end
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#180
  def updated?; end
end
...
#
# source://sinatra-contrib//lib/sinatra/reloader.rb#113
...
# ignored.
#
# source://sinatra-contrib//lib/sinatra/reloader.rb#122
class Sinatra::Reloader::Watcher::List
  # Creates a new +List+ instance.
  #
  # @return [List] a new instance of List
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#131
  def initialize; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#147
  def ignore(path); end

  # Returns an array with all the watchers in the +List+ that
  # have been updated.
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#165
  def updated; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/reloader.rb#159
  def watchers; end

  class << self
    # Returns the +List+ for the application +app+.
    #
    # source://sinatra-contrib//lib/sinatra/reloader.rb#126
    def for(app); end
  end
end
...
#     end
#
# source://sinatra-contrib//lib/sinatra/required_params.rb#46
module Sinatra::RequiredParams
  # source://sinatra-contrib//lib/sinatra/required_params.rb#47
  def required_params(*keys); end

  private

  # source://sinatra-contrib//lib/sinatra/required_params.rb#53
...
#
# source://sinatra-contrib//lib/sinatra/respond_with.rb#88
module Sinatra::RespondWith
  # source://sinatra-contrib//lib/sinatra/respond_with.rb#197
  def mime_type(*_arg0); end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#190
  def remap_extensions; end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#216
  def rendering_method(engine); end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#203
  def respond_to(*formats); end

  private

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#224
  def compile!(verb, path, block, **options); end

  class << self
    # source://sinatra-contrib//lib/sinatra/respond_with.rb#238
    def engines; end

    # source://sinatra-contrib//lib/sinatra/respond_with.rb#229
    def jrubyify(engs); end

    # source://sinatra-contrib//lib/sinatra/respond_with.rb#253
    def registered(base); end
  end
end

# source://sinatra-contrib//lib/sinatra/respond_with.rb#89
class Sinatra::RespondWith::Format
  ...
  #
  # source://sinatra-contrib//lib/sinatra/respond_with.rb#104
  def finish; end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#121
  def method_missing(method, *args, &block); end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#94
  def on(type, &block); end
end

# source://sinatra-contrib//lib/sinatra/respond_with.rb#127
module Sinatra::RespondWith::Helpers
  include ::Sinatra::JSON

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#160
  def respond_to(&block); end

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#130
  def respond_with(template, object = T.unsafe(nil), &block); end

  private

  # source://sinatra-contrib//lib/sinatra/respond_with.rb#166
...
#   end
#
# source://sinatra-contrib//lib/sinatra/streaming.rb#77
module Sinatra::Streaming
  # source://sinatra-contrib//lib/sinatra/streaming.rb#78
  def stream(*_arg0); end
end

# source://sinatra-contrib//lib/sinatra/streaming.rb#86
module Sinatra::Streaming::Stream
  # @raise [IOError]
  #
  # source://sinatra-contrib//lib/sinatra/streaming.rb#98
  def <<(data); end
  ...
  # @raise [IOError]
  #
  # source://sinatra-contrib//lib/sinatra/streaming.rb#156
  def close_read; end
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/streaming.rb#174
  def closed?; end
  ...
  # source://sinatra-contrib//lib/sinatra/streaming.rb#108
  def each; end
  ...
  # source://sinatra-contrib//lib/sinatra/streaming.rb#114
  def map(&block); end

  # source://sinatra-contrib//lib/sinatra/streaming.rb#119
  def map!(&block); end
  ...
  # source://sinatra-contrib//lib/sinatra/streaming.rb#138
  def print(*args); end

  # source://sinatra-contrib//lib/sinatra/streaming.rb#143
  ...
  # source://sinatra-contrib//lib/sinatra/streaming.rb#130
...
#
# source://sinatra-contrib//lib/sinatra/test_helpers.rb#15
module Sinatra::TestHelpers
  ...
  # @return [Sinatra::Base]
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#162
  def app; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#147
  def app=(base); end
  ...
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#212
  ...
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#208
  def last_env; end

  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#192
  ...
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#134
  ...
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#201
  def session; end
  ...
  #
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#31
  def settings; end
...
class Sinatra::TestHelpers::Session < ::Rack::Test::Session
  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#18
  def global_env; end

  private

  # source://sinatra-contrib//lib/sinatra/test_helpers.rb#24
  def default_env; end
end
