...
class Mongo::Auth::Aws::Conversation < ::Mongo::Auth::SaslConversationBase
  ...
  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/conversation.rb#91
  def client_final_payload; end

  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/conversation.rb#72
...
# @api private
#
# source://mongo//lib/mongo/auth/aws.rb#33
...
# @api private
#
# source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#43
class Mongo::Auth::Aws::CredentialsRetriever
  # @api private
  # @return [CredentialsRetriever] a new instance of CredentialsRetriever
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#51
  ...
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#66
  def credentials; end

  # @api private
  # @return [Auth::User | nil] The user object, if one was provided.
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#56
  def user; end
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#194
  ...
  #   if retrieval failed.
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#112
  def ec2_metadata_credentials; end

  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#153
  def ecs_metadata_credentials; end

  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#183
...
# @api private
#
# source://mongo//lib/mongo/auth/aws/credentials_retriever.rb#49
...
class Mongo::Auth::Aws::Request
  ...
  #
  # source://mongo//lib/mongo/auth/aws/request.rb#236
  ...
  #
  # source://mongo//lib/mongo/auth/aws/request.rb#244
  def validate!; end
  ...
  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/request.rb#274
  def hmac(key, data); end

  # @api private
  #
  # source://mongo//lib/mongo/auth/aws/request.rb#278
...
# @api private
#
# source://mongo//lib/mongo/auth/scram256.rb#28
...
class Mongo::BulkWrite
  ...
  # @param requests [Array<Hash, BSON::Document>] The requests, cannot be empty.
  # @param options [Hash, BSON::Document] The options.
  # @return [BulkWrite] a new instance of BulkWrite
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/bulk_write.rb#122
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/bulk_write.rb#138
  def ordered?; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/bulk_write.rb#152
  ...
  # source://mongo//lib/mongo/bulk_write.rb#168
  ...
  #
  # source://mongo//lib/mongo/bulk_write.rb#371
  def maybe_first(obj); end

  # source://mongo//lib/mongo/bulk_write.rb#217
  def op_combiner; end

  # source://mongo//lib/mongo/bulk_write.rb#249
  def replace_one(documents, connection, context, operation_id, session, txn_num); end

  # @return [Boolean]
  #
  # source://mongo//lib/mongo/bulk_write.rb#164
  def single_statement?(operation); end

  # source://mongo//lib/mongo/bulk_write.rb#221
  def split_execute(name, values, connection, context, operation_id, result_combiner, session, txn_num); end

  # source://mongo//lib/mongo/bulk_write.rb#257
  ...
  # source://mongo//lib/mongo/bulk_write.rb#272
  def validate_array_filters!(connection); end

  # source://mongo//lib/mongo/bulk_write.rb#266
  def validate_collation!(connection); end

  # source://mongo//lib/mongo/bulk_write.rb#278
  ...
  #
  # source://mongo//lib/mongo/bulk_write.rb#332
...
# source://mongo//lib/mongo/bulk_write.rb#160
...
class Mongo::Client
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#482
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#175
  def ==(other); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#192
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/client.rb#861
  def close; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#871
  def close_encrypter; end

  # @return [Mongo::Cluster] cluster The cluster of servers for the client.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#136
  def cluster; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#139
  def database; end
  ...
  # @since 2.0.5
  #
  # source://mongo//lib/mongo/client.rb#922
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1160
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#146
  def encrypter; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1103
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#204
  def hash; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#674
  def inspect; end
  ...
  # @since 2.0.5
  #
  # source://mongo//lib/mongo/client.rb#948
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/client.rb#971
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#642
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#662
  def max_write_retries; end

  # @return [Hash] options The configuration options.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#142
  def options; end
  ...
  # @since 2.6.0
  #
  # source://mongo//lib/mongo/client.rb#839
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#722
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#652
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/client.rb#885
  def reconnect; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/client.rb#996
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/client.rb#686
  def summary; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#789
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#741
  def use(name); end
  ...
  # @since 2.6.0
  #
  # source://mongo//lib/mongo/client.rb#1073
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#763
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1129
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#852
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1167
  def build_encrypter; end

  # @return [Boolean]
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1249
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1175
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1216
  def get_session!(options = T.unsafe(nil)); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#156
  def monitoring; end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1525
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1470
  def validate_authentication_options!; end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1556
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1262
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1336
  def validate_options!(addresses = T.unsafe(nil), is_srv: T.unsafe(nil)); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1566
  def validate_read!(option, opts); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1538
  def validate_snappy_compression!; end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/client.rb#1547
  ...
  class << self
    ...
    # @since 2.0.0
    #
    # source://mongo//lib/mongo/client.rb#1144
...
# @since 2.5.0
#
# source://mongo//lib/mongo/client.rb#124
...
# @since 2.0.0
#
# source://mongo//lib/mongo/client.rb#131
...
class Mongo::ClientEncryption
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#140
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#129
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#150
  ...
  #   if not found.
  #
  # source://mongo//lib/mongo/client_encryption.rb#160
  def get_key(id); end
  ...
  #   if not found.
  #
  # source://mongo//lib/mongo/client_encryption.rb#170
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#177
  def get_keys; end
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#189
  ...
  #
  # source://mongo//lib/mongo/client_encryption.rb#204
...
class Mongo::Cluster
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#725
  def ==(other); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#823
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/cluster.rb#503
  def disconnect!; end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#928
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/cluster.rb#742
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/cluster.rb#754
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#771
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/cluster.rb#547
  def reconnect!; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#869
  ...
  # @param aptions [Hash] a customizable set of options
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#631
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#592
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#921
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#698
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/cluster.rb#800
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cluster.rb#959
...
class Mongo::Cluster::SdamFlow
  ...
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#366
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#591
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#560
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#484
  def commit_changes; end

  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#536
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#437
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#407
  def remove; end
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#385
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#576
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#547
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#604
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#283
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#320
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cluster/sdam_flow.rb#616
...
class Mongo::Collection
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#118
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#428
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#725
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#243
  def capped?; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#532
  ...
  # @since 2.6.0
  #
  # source://mongo//lib/mongo/collection.rb#562
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#269
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#769
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#747
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#604
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#327
  ...
  # @since 2.6.0
  #
  # source://mongo//lib/mongo/collection.rb#583
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#393
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#907
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#985
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#947
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#621
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#697
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#650
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#633
  def inspect; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#997
  def namespace; end
  ...
  # @since 2.1
  #
  # source://mongo//lib/mongo/collection.rb#792
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/collection.rb#144
  def read_concern; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#168
  def read_preference; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#156
  def server_selector; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#1006
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#848
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#877
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/collection.rb#499
  def watch(pipeline = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection.rb#221
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#180
  def write_concern; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection.rb#195
...
# @api private
#
# source://mongo//lib/mongo/collection/queryable_encryption.rb#24
module Mongo::Collection::QueryableEncryption
  ...
  #
  # source://mongo//lib/mongo/collection/queryable_encryption.rb#34
  ...
  # @return [Result] The result of provided block.
  #
  # source://mongo//lib/mongo/collection/queryable_encryption.rb#74
  ...
  #
  # source://mongo//lib/mongo/collection/queryable_encryption.rb#112
...
module Mongo::Collection::View::Readable
  ...
  # @since 2.3.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#627
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#318
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#361
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#375
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#391
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#599
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#408
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#613
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#422
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#436
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#580
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#449
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#467
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#483
  def read(value = T.unsafe(nil)); end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#632
  def read_concern; end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#641
  def read_preference; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#498
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#513
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#529
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#547
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#562
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#662
  def collation(doc = T.unsafe(nil)); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#674
  def parallel_scan(cursor_count, options = T.unsafe(nil)); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#666
  def server_selector; end

  # @raise [Error::InvalidDocument]
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/readable.rb#716
...
module Mongo::Collection::View::Writable
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#233
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#292
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#129
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#166
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#357
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#429
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#501
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#577
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/collection/view/writable.rb#555
...
# @api private
#
# source://mongo//lib/mongo/config/options.rb#4
module Mongo::Config
  extend ::Forwardable
  extend ::Mongo::Config::Options
  extend ::Mongo::Config

  # source://mongo//lib/mongo/config/options.rb#27
  def broken_view_aggregate; end

  # source://mongo//lib/mongo/config/options.rb#31
  def broken_view_aggregate=(value); end

  # source://mongo//lib/mongo/config/options.rb#35
  def broken_view_aggregate?; end
  ...
  #
  # source://mongo//lib/mongo/config.rb#35
...
#
# source://mongo//lib/mongo/config/options.rb#7
module Mongo::Config::Options
  # Get the defaults or initialize a new empty hash.
  #
  # @return [Hash] The default options.
  #
  # source://mongo//lib/mongo/config/options.rb#12
  def defaults; end
  ...
  #
  # source://mongo//lib/mongo/config/options.rb#22
  ...
  #
  # source://mongo//lib/mongo/config/options.rb#47
  def reset; end
  ...
  #
  # source://mongo//lib/mongo/config/options.rb#57
  def settings; end
end

# source://mongo//lib/mongo/config/validators/option.rb#5
...
# @api private
#
# source://mongo//lib/mongo/config/validators/option.rb#10
module Mongo::Config::Validators::Option
  ...
  #
  # source://mongo//lib/mongo/config/validators/option.rb#18
...
class Mongo::Crypt::AutoEncrypter
  ...
  # @return [true] Always true.
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#215
  def close; end
  ...
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#204
  ...
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#179
  def encrypt?; end
  ...
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#295
  ...
  # @api private
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#241
  ...
  #
  # source://mongo//lib/mongo/crypt/auto_encrypter.rb#268
...
class Mongo::Crypt::Context
  ...
  #
  # source://mongo//lib/mongo/crypt/context.rb#37
  def initialize(mongocrypt_handle, io); end

  # @api private
  #
  # source://mongo//lib/mongo/crypt/context.rb#52
  def ctx_p; end
  ...
  #
  # source://mongo//lib/mongo/crypt/context.rb#73
  ...
  # @api private
  #
  # source://mongo//lib/mongo/crypt/context.rb#127
  ...
  #
  # source://mongo//lib/mongo/crypt/context.rb#136
...
# @api private
#
# source://mongo//lib/mongo/crypt/explicit_encrypter.rb#25
class Mongo::Crypt::ExplicitEncrypter
  ...
  #   before adding the key alt name, or nil if no such key.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#137
  def add_key_alt_name(id, key_alt_name); end
  ...
  #   BSON::Binary object with type :uuid.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#66
  ...
  # @return [Object] The decrypted value
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#122
  def decrypt(value); end
  ...
  #   operation that deletes the key.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#147
  def delete_key(id); end
  ...
  #   representing the encrypted value
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#107
  ...
  #   if not found.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#157
  def get_key(id); end
  ...
  # @return [Collection::View] Keys in the key vault collection.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#174
  def get_keys; end
  ...
  #   before removing the key alt name, or nil if no such key.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#185
  def remove_key_alt_name(id, key_alt_name); end
  ...
  # @return [Crypt::RewrapManyDataKeyResult] Result of the operation.
  #
  # source://mongo//lib/mongo/crypt/explicit_encrypter.rb#200
  def rewrap_many_data_key(filter, opts = T.unsafe(nil)); end
end
...
class Mongo::Crypt::ExplicitEncryptionContext < ::Mongo::Crypt::Context
  ...
  #
  # source://mongo//lib/mongo/crypt/explicit_encryption_context.rb#53
...
# source://mongo//lib/mongo/crypt/kms/aws.rb#21
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/aws.rb#26
class Mongo::Crypt::KMS::AWS::Credentials
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#55
  def initialize(opts); end

  # @api private
  # @return [String] AWS access key.
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#31
  def access_key_id; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#34
  def secret_access_key; end

  # @api private
  # @return [String | nil] AWS session token.
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#37
  def session_token; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#67
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/aws.rb#42
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/aws.rb#83
class Mongo::Crypt::KMS::AWS::MasterKeyDocument
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#107
  def initialize(opts); end

  # @api private
  # @return [String | nil] AWS KMS endpoint.
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#93
  def endpoint; end

  # @api private
  # @return [String] AWS KMS key.
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#90
  def key; end

  # @api private
  # @return [String] AWS region.
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#87
  def region; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/aws.rb#121
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/aws.rb#95
Mongo::Crypt::KMS::AWS::MasterKeyDocument::FORMAT_HINT = T.let(T.unsafe(nil), String)

# source://mongo//lib/mongo/crypt/kms/azure.rb#21
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/azure.rb#25
class Mongo::Crypt::KMS::Azure::Credentials
  ...
  # @return [Credentials] a new instance of Credentials
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#59
  def initialize(opts); end

  # @api private
  # @return [String] Azure client id.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#33
  def client_id; end

  # @api private
  # @return [String] Azure client secret.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#36
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#39
  def identity_platform_endpoint; end

  # @api private
  # @return [String] Azure tenant id.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#30
  def tenant_id; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#74
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/azure.rb#44
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/azure.rb#91
class Mongo::Crypt::KMS::Azure::MasterKeyDocument
  ...
  # @return [MasterKeyDocument] a new instance of MasterKeyDocument
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#115
  def initialize(opts); end

  # @api private
  # @return [String] Azure KMS key name.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#98
  def key_name; end

  # @api private
  # @return [String] Azure key vault endpoint.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#95
  def key_vault_endpoint; end

  # @api private
  # @return [String | nil] Azure KMS key version.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#101
  def key_version; end
  ...
  # @return [BSON::Document] Azure KMS credentials in libmongocrypt format.
  #
  # source://mongo//lib/mongo/crypt/kms/azure.rb#129
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/azure.rb#103
...
class Mongo::Crypt::KMS::Credentials
  ...
  # @return [Credentials] a new instance of Credentials
  #
  # source://mongo//lib/mongo/crypt/kms/credentials.rb#39
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/credentials.rb#69
  def to_document; end
end

# source://mongo//lib/mongo/crypt/kms/gcp.rb#21
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/gcp.rb#26
class Mongo::Crypt::KMS::GCP::Credentials
  ...
  # @return [Credentials] a new instance of Credentials
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#56
  def initialize(opts); end

  # @api private
  # @return [String] GCP email to authenticate with.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#31
  def email; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#37
  def endpoint; end

  # @api private
  # @return [String] GCP private key, base64 encoded DER format.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#34
  def private_key; end
  ...
  # @return [BSON::Document] Azure KMS credentials in libmongocrypt format.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#99
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/gcp.rb#42
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/gcp.rb#115
class Mongo::Crypt::KMS::GCP::MasterKeyDocument
  ...
  # @return [MasterKeyDocument] a new instance of MasterKeyDocument
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#152
  def initialize(opts); end

  # @api private
  # @return [String | nil] GCP KMS endpoint.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#134
  def endpoint; end

  # @api private
  # @return [String] GCP KMS key name.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#128
  def key_name; end

  # @api private
  # @return [String] GCP KMS key ring.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#125
  def key_ring; end

  # @api private
  # @return [String | nil] GCP KMS key version.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#131
  def key_version; end

  # @api private
  # @return [String] GCP location.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#122
  def location; end

  # @api private
  # @return [String] GCP project id.
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#119
  def project_id; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/gcp.rb#168
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/gcp.rb#136
Mongo::Crypt::KMS::GCP::MasterKeyDocument::FORMAT_HINT = T.let(T.unsafe(nil), String)

# source://mongo//lib/mongo/crypt/kms/kmip.rb#21
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/kmip.rb#26
class Mongo::Crypt::KMS::KMIP::Credentials
  ...
  # @return [Credentials] a new instance of Credentials
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#47
  def initialize(opts); end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#31
  def endpoint; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#57
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/kmip.rb#36
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/kmip.rb#68
class Mongo::Crypt::KMS::KMIP::MasterKeyDocument
  ...
  # @return [MasterKeyDocument] a new instance of MasterKeyDocument
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#92
  def initialize(opts = T.unsafe(nil)); end

  # @api private
  # @return [String | nil] KMIP KMS endpoint with optional port.
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#76
  def endpoint; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#73
  def key_id; end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/kmip.rb#104
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/kmip.rb#78
Mongo::Crypt::KMS::KMIP::MasterKeyDocument::FORMAT_HINT = T.let(T.unsafe(nil), String)

# source://mongo//lib/mongo/crypt/kms/local.rb#21
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/local.rb#25
class Mongo::Crypt::KMS::Local::Credentials
  ...
  # @return [Credentials] a new instance of Credentials
  #
  # source://mongo//lib/mongo/crypt/kms/local.rb#46
  def initialize(opts); end
  ...
  #
  # source://mongo//lib/mongo/crypt/kms/local.rb#30
  def key; end

  # @api private
  # @return [BSON::Document] Local KMS credentials in libmongocrypt format.
  #
  # source://mongo//lib/mongo/crypt/kms/local.rb#54
  def to_document; end
end

# @api private
#
# source://mongo//lib/mongo/crypt/kms/local.rb#35
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms/local.rb#65
class Mongo::Crypt::KMS::Local::MasterKeyDocument
  ...
  # @return [MasterKeyDocument] a new instance of MasterKeyDocument
  #
  # source://mongo//lib/mongo/crypt/kms/local.rb#69
  ...
  # @return [BSON::Document] Local KMS credentials in libmongocrypt format.
  #
  # source://mongo//lib/mongo/crypt/kms/local.rb#75
  def to_document; end
end
...
# @api private
#
# source://mongo//lib/mongo/crypt/kms.rb#24
module Mongo::Crypt::KMS::Validations
  ...
  #
  # source://mongo//lib/mongo/crypt/kms.rb#37
  ...
  #
  # source://mongo//lib/mongo/crypt/kms.rb#81
...
class Mongo::Cursor
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/cursor.rb#253
  def batch_size; end
  ...
  # @return [nil] Always nil.
  #
  # source://mongo//lib/mongo/cursor.rb#282
  def close; end
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/cursor.rb#270
  def closed?; end
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/cursor.rb#310
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cursor.rb#143
  def each; end

  # @api private
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cursor.rb#384
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/cursor.rb#337
  def id; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#97
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/cursor.rb#125
  def inspect; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#372
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#94
  def server; end
  ...
  # @since 2.2.0
  #
  # source://mongo//lib/mongo/cursor.rb#350
  def to_return; end
  ...
  #
  # source://mongo//lib/mongo/cursor.rb#197
  def try_next; end
  ...
  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#390
  def batch_size_for_get_more; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#408
  def cache_batch_resume_token; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#402
  def cache_resume_token(doc); end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#437
  def end_session; end
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cursor.rb#398
  def exhausted?; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#412
  def get_more_operation; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#470
  def limit; end

  # @api private
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cursor.rb#441
  def limited?; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#445
  def process(result); end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#474
  def register; end

  # @api private
  #
  # source://mongo//lib/mongo/cursor.rb#478
  def unregister; end

  # @api private
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/cursor.rb#466
  def use_limit?; end
  ...
  class << self
    ...
    #
    # source://mongo//lib/mongo/cursor.rb#108
...
class Mongo::Database::View
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/database/view.rb#124
  def initialize(database); end
  ...
  # @since 2.10.0
  #
  # source://mongo//lib/mongo/database/view.rb#148
  def aggregate(pipeline, options = T.unsafe(nil)); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/database/view.rb#132
  def database; end
  ...
  # @since 2.0.5
  #
  # source://mongo//lib/mongo/database/view.rb#111
  def list_collections(options = T.unsafe(nil)); end
...
#
# source://mongo//lib/mongo/error/crypt_error.rb#26
...
# @since 2.6.0
#
# source://mongo//lib/mongo/error/failed_string_prep_validation.rb#13
...
# set.
#
# source://mongo//lib/mongo/error/invalid_config_option.rb#8
class Mongo::Error::InvalidConfigOption < ::Mongo::Error
  ...
  #
  # source://mongo//lib/mongo/error/invalid_config_option.rb#15
...
#
# source://mongo//lib/mongo/error/invalid_read_concern.rb#23
...
#
# source://mongo//lib/mongo/error/missing_connection.rb#22
...
#
# source://mongo//lib/mongo/error/no_service_connection_available.rb#24
...
module Mongo::Error::Notable
  ...
  # @since 2.11.0
  #
  # source://mongo//lib/mongo/error/notable.rb#64
  def generation; end
  ...
  # @since 2.11.0
  #
  # source://mongo//lib/mongo/error/notable.rb#81
  def to_s; end
...
class Mongo::Error::PoolClosedError < ::Mongo::Error
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/error/pool_closed_error.rb#45
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/error/pool_closed_error.rb#30
  def address; end
  ...
  # @since 2.11.0
  #
  # source://mongo//lib/mongo/error/pool_closed_error.rb#36
  def pool; end
end
...
#
# source://mongo//lib/mongo/error/unsupported_option.rb#27
...
class Mongo::Grid::File::Chunk
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/grid/file/chunk.rb#140
  ...
  class << self
    ...
    # @since 2.0.0
    #
    # source://mongo//lib/mongo/grid/file/chunk.rb#158
    ...
    # @since 2.0.0
    #
    # source://mongo//lib/mongo/grid/file/chunk.rb#175
...
class Mongo::Grid::File::Info
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/grid/file/info.rb#235
  def to_bson(buffer = T.unsafe(nil), validating_keys = T.unsafe(nil)); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/grid/file/info.rb#250
  def upload_date; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/grid/file/info.rb#256
...
class Mongo::Monitoring::Event::Cmap::PoolCleared < ::Mongo::Monitoring::Event::Cmap::Base
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/monitoring/event/cmap/pool_cleared.rb#43
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/monitoring/event/cmap/pool_cleared.rb#56
  def summary; end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/operation.rb#103
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/aggregate/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/aggregate/command.rb#27
class Mongo::Operation::Aggregate::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/aggregate/command.rb#49
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/aggregate/command.rb#37
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/aggregate/command.rb#45
...
# @since 2.5.0
#
# source://mongo//lib/mongo/operation.rb#114
...
# @since 2.4.0
#
# source://mongo//lib/mongo/operation.rb#98
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/collections_info/command.rb#20
class Mongo::Operation::CollectionsInfo
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/collections_info.rb#36
...
# @api private
#
# source://mongo//lib/mongo/operation/collections_info/command.rb#25
class Mongo::Operation::CollectionsInfo::Command
  ...
  # @api private
  #
  # source://mongo//lib/mongo/operation/collections_info/command.rb#33
  def get_result(connection, context, options = T.unsafe(nil)); end

  # @api private
  #
  # source://mongo//lib/mongo/operation/collections_info/command.rb#42
  def message(connection); end

  # @api private
  #
  # source://mongo//lib/mongo/operation/collections_info/command.rb#38
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/command/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/command/command.rb#27
class Mongo::Operation::Command::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/command/command.rb#35
  def message(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/count/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/count/command.rb#27
class Mongo::Operation::Count::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/count/command.rb#41
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/count/command.rb#35
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/create/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/create/command.rb#27
class Mongo::Operation::Create::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create/command.rb#41
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create/command.rb#35
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/create_index/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/create_index/command.rb#27
class Mongo::Operation::CreateIndex::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create_index/command.rb#55
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create_index/command.rb#35
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/create_user/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/create_user/command.rb#27
class Mongo::Operation::CreateUser::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create_user/command.rb#40
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/create_user/command.rb#36
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/delete/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/delete/command.rb#27
class Mongo::Operation::Delete::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/delete/command.rb#46
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/delete/command.rb#38
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/delete.rb#37
...
# @since 2.5.0
#
# source://mongo//lib/mongo/operation/distinct/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/distinct/command.rb#27
class Mongo::Operation::Distinct::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/distinct/command.rb#41
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/distinct/command.rb#35
  def selector(connection); end
end
...
# @since 2.4.0
#
# source://mongo//lib/mongo/operation/drop/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/drop/command.rb#27
class Mongo::Operation::Drop::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/drop/command.rb#35
  def message(connection); end
end
...
# @since 2.4.0
#
# source://mongo//lib/mongo/operation/drop_database/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/drop_database/command.rb#27
class Mongo::Operation::DropDatabase::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/drop_database/command.rb#35
  def message(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/drop_index/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/drop_index/command.rb#27
class Mongo::Operation::DropIndex::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/drop_index/command.rb#39
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/drop_index/command.rb#35
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/explain/command.rb#27
class Mongo::Operation::Explain::Command
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/explain/command.rb#52
  def message(connection); end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/explain/command.rb#36
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/explain/legacy.rb#27
class Mongo::Operation::Explain::Legacy
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/explain/legacy.rb#35
  def message(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/find/command.rb#20
...
# @api private
#
# source://mongo//lib/mongo/operation/find/builder/legacy.rb#26
module Mongo::Operation::Find::Builder::Legacy
  private

  # @api private
  #
  # source://mongo//lib/mongo/operation/find/builder/legacy.rb#88
  def query_options(spec, connection); end

  # @api private
  #
  # source://mongo//lib/mongo/operation/find/builder/legacy.rb#106
  def read_pref_formatted(spec); end

  # @api private
  #
  # source://mongo//lib/mongo/operation/find/builder/legacy.rb#45
  def selector(spec, connection); end
...
# @since 2.2.0
#
# source://mongo//lib/mongo/operation/find/builder/legacy.rb#31
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/find/command.rb#27
class Mongo::Operation::Find::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/find/command.rb#45
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/find/command.rb#36
  def selector(connection); end
end
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/find/legacy/result.rb#21
class Mongo::Operation::Find::Legacy
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/find/legacy.rb#37
  def message(connection); end
end
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation/find/legacy/result.rb#27
class Mongo::Operation::Find::Legacy::Result < ::Mongo::Operation::Result
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/find/legacy/result.rb#39
  def successful?; end
end
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/get_more/command.rb#27
class Mongo::Operation::GetMore::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/get_more/command.rb#37
  def message(connection); end
end
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/get_more/legacy.rb#27
class Mongo::Operation::GetMore::Legacy
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/get_more/legacy.rb#33
  def message(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/indexes/command.rb#20
class Mongo::Operation::Indexes
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/indexes.rb#38
  def final_operation(connection); end
end
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/indexes/command.rb#27
class Mongo::Operation::Indexes::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/indexes/command.rb#36
  def message(connection); end
end
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/indexes/legacy.rb#27
class Mongo::Operation::Indexes::Legacy
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/indexes/legacy.rb#38
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/indexes/legacy.rb#42
  def result_class; end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/indexes/legacy.rb#34
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/insert/command.rb#20
class Mongo::Operation::Insert
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/operation/insert.rb#39
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/insert/command.rb#27
class Mongo::Operation::Insert::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/insert/command.rb#38
  def get_result(connection, context, options = T.unsafe(nil)); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/insert/command.rb#49
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/insert/command.rb#43
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/insert.rb#37
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/kill_cursors/command.rb#27
class Mongo::Operation::KillCursors::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/kill_cursors/command.rb#42
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/kill_cursors/command.rb#35
  def selector(connection); end
end
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation.rb#83
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/list_collections/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/list_collections/command.rb#27
class Mongo::Operation::ListCollections::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/list_collections/command.rb#40
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/list_collections/command.rb#36
  def selector(connection); end
end
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation.rb#88
...
# @since 2.5.0
#
# source://mongo//lib/mongo/operation/map_reduce/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/map_reduce/command.rb#27
class Mongo::Operation::MapReduce::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/map_reduce/command.rb#45
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/map_reduce/command.rb#37
  def selector(connection); end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/operation.rb#108
...
# @api private
#
# source://mongo//lib/mongo/operation/shared/op_msg_or_command.rb#25
module Mongo::Operation::OpMsgOrCommand
  ...
  # @api private
  #
  # source://mongo//lib/mongo/operation/shared/op_msg_or_command.rb#31
  def final_operation(connection); end
end
...
# @api private
#
# source://mongo//lib/mongo/operation/shared/op_msg_or_find_command.rb#26
module Mongo::Operation::OpMsgOrFindCommand
  ...
  # @api private
  #
  # source://mongo//lib/mongo/operation/shared/op_msg_or_find_command.rb#32
  def final_operation(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/parallel_scan/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/parallel_scan/command.rb#27
class Mongo::Operation::ParallelScan::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/parallel_scan/command.rb#46
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/parallel_scan/command.rb#36
  def selector(connection); end
end
...
# @api private
#
# source://mongo//lib/mongo/operation/shared/polymorphic_operation.rb#25
module Mongo::Operation::PolymorphicOperation
  ...
  #
  # source://mongo//lib/mongo/operation/shared/polymorphic_operation.rb#34
  ...
  # @return [Mongo::Operation::Result] The operation result.
  #
  # source://mongo//lib/mongo/operation/shared/polymorphic_operation.rb#48
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation.rb#73
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/remove_user/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/remove_user/command.rb#27
class Mongo::Operation::RemoveUser::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/remove_user/command.rb#40
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/remove_user/command.rb#36
  def selector(connection); end
end
...
module Mongo::Operation::SessionsSupported
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#168
  def add_read_preference(sel, connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#97
  def add_write_concern!(sel); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#101
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#52
  def apply_causal_consistency!(selector, connection); end
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#65
  def apply_causal_consistency_if_possible(selector, connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#80
  def apply_cluster_time!(selector, connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#113
  def apply_read_pref!(selector); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#216
  def apply_session_options(sel, connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#105
  def apply_start_transaction!(selector); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#109
  def apply_txn_num!(selector); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#117
  def apply_txn_opts!(selector); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#245
  def build_message(connection, context); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#129
  def command(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#76
  def flags; end
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#93
  def read_command?(sel); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#121
  def suppress_read_write_concern!(selector); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/shared/sessions_supported.rb#125
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation.rb#78
...
# @since 2.1.0
#
# source://mongo//lib/mongo/operation.rb#93
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/update/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/update/command.rb#27
class Mongo::Operation::Update::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/update/command.rb#47
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/update/command.rb#39
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/update.rb#37
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/update_user/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/update_user/command.rb#27
class Mongo::Operation::UpdateUser::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/update_user/command.rb#39
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/update_user/command.rb#35
  def selector(connection); end
end
...
# @since 2.0.0
#
# source://mongo//lib/mongo/operation/users_info/command.rb#20
...
# @since 2.5.2
#
# source://mongo//lib/mongo/operation/users_info/command.rb#27
class Mongo::Operation::UsersInfo::Command
  ...
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/users_info/command.rb#40
  def message(connection); end

  # @api private
  # @since 2.5.2
  #
  # source://mongo//lib/mongo/operation/users_info/command.rb#36
  def selector(connection); end
end
...
# @api private
#
# source://mongo//lib/mongo/operation/write_command/command.rb#20
...
# @api private
#
# source://mongo//lib/mongo/operation/write_command/command.rb#25
class Mongo::Operation::WriteCommand::Command
  ...
  # @api private
  #
  # source://mongo//lib/mongo/operation/write_command/command.rb#45
  def message(connection); end

  # @api private
  #
  # source://mongo//lib/mongo/operation/write_command/command.rb#34
  def selector(connection); end
end
...
class Mongo::Protocol::CachingHash
  ...
  #
  # source://mongo//lib/mongo/protocol/caching_hash.rb#43
  def to_bson(buffer = T.unsafe(nil), validating_keys = T.unsafe(nil)); end
  ...
  #   with validation.
  #
  # source://mongo//lib/mongo/protocol/caching_hash.rb#64
  def needs_validation?(validating_keys); end
end
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/delete.rb#31
class Mongo::Protocol::Delete < ::Mongo::Protocol::Message
  ...
  #
  # source://mongo//lib/mongo/protocol/delete.rb#46
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#63
  def payload; end
  ...
  # @api semipublic
  #
  # source://mongo//lib/mongo/protocol/delete.rb#74
  def upconverter; end
end
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/delete.rb#85
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/delete.rb#82
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/delete.rb#106
class Mongo::Protocol::Delete::Upconverter
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#136
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#119
  def collection; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#150
  def command; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#122
  def filter; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#125
  def options; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/delete.rb#160
  def limit; end
end
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/delete.rb#111
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/delete.rb#116
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/insert.rb#36
class Mongo::Protocol::Insert < ::Mongo::Protocol::Message
  ...
  #
  # source://mongo//lib/mongo/protocol/insert.rb#56
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#74
  def payload; end
  ...
  # @api semipublic
  #
  # source://mongo//lib/mongo/protocol/insert.rb#85
  def upconverter; end
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/protocol/insert.rb#89
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/insert.rb#100
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/insert.rb#97
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/insert.rb#118
class Mongo::Protocol::Insert::Upconverter
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#154
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#136
  def collection; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#168
  def command; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#139
  def documents; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/insert.rb#142
  def options; end
end
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/insert.rb#128
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/insert.rb#123
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/insert.rb#133
...
class Mongo::Protocol::Message
  ...
  # @return [Boolean]
  #
  # source://mongo//lib/mongo/protocol/message.rb#460
  def validating_keys?; end
...
class Mongo::Protocol::Msg < ::Mongo::Protocol::Message
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#65
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#271
  def bulk_write?; end

  # @api private
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#195
  def documents; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#183
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#283
  def maybe_add_server_api(server_api); end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#173
  def maybe_compress(compressor, zlib_compression_level = T.unsafe(nil)); end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#250
  def maybe_decrypt(context); end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#213
  def maybe_encrypt(connection, context); end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#310
  def number_returned; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#119
  def payload; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#107
  def replyable?; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#154
  def serialize(buffer = T.unsafe(nil), max_bson_size = T.unsafe(nil), bson_overhead = T.unsafe(nil)); end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#353
  def add_check_sum(buffer); end

  # @api private
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#340
  def command; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#325
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/msg.rb#392
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/msg.rb#385
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/msg.rb#383
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/msg.rb#364
class Mongo::Protocol::Msg::Section1
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#371
  def ==(other); end

  # @api private
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/protocol/msg.rb#369
  def documents; end
...
class Mongo::Protocol::Serializers::BitVector
  ...
  #
  # source://mongo//lib/mongo/protocol/bit_vector.rb#56
  ...
  #
  # source://mongo//lib/mongo/protocol/bit_vector.rb#44
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#397
module Mongo::Protocol::Serializers::Byte
  class << self
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#420
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#408
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#428
module Mongo::Protocol::Serializers::Bytes
  class << self
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#453
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#439
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#75
module Mongo::Protocol::Serializers::CString
  class << self
    ...
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#83
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#351
module Mongo::Protocol::Serializers::Document
  class << self
    ...
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#379
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @return [String] Buffer with serialized value.
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#359
    ...
    # @since 2.0.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#389
...
module Mongo::Protocol::Serializers::Header
  class << self
    ...
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#67
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @return [String] Buffer with serialized value.
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#56
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#107
module Mongo::Protocol::Serializers::Int32
  class << self
    ...
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#133
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @return [String] Buffer with serialized value.
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#115
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#141
module Mongo::Protocol::Serializers::Int64
  class << self
    ...
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#167
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @return [String] Buffer with serialized value.
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#149
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#177
module Mongo::Protocol::Serializers::Sections
  class << self
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#216
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#189
    def serialize(buffer, value, max_bson_size = T.unsafe(nil), validating_keys = T.unsafe(nil)); end
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#237
    def size_limited?; end
  end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#292
module Mongo::Protocol::Serializers::Sections::PayloadOne
  class << self
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#332
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#314
    def serialize(buffer, value, max_bson_size = T.unsafe(nil), validating_keys = T.unsafe(nil)); end
  end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#297
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#302
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#244
module Mongo::Protocol::Serializers::Sections::PayloadZero
  class << self
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#283
    def deserialize(buffer, options = T.unsafe(nil)); end
    ...
    # @since 2.5.0
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#266
    def serialize(buffer, value, max_bson_size = T.unsafe(nil), validating_keys = T.unsafe(nil)); end
  end
end
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#249
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/serializers.rb#254
...
# @api private
#
# source://mongo//lib/mongo/protocol/serializers.rb#91
module Mongo::Protocol::Serializers::Zero
  class << self
    ...
    # @return [String] Buffer with serialized value.
    #
    # source://mongo//lib/mongo/protocol/serializers.rb#99
    def serialize(buffer, value, validating_keys = T.unsafe(nil)); end
  end
end
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/update.rb#34
class Mongo::Protocol::Update < ::Mongo::Protocol::Message
  ...
  #
  # source://mongo//lib/mongo/protocol/update.rb#57
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#76
  def payload; end
  ...
  # @api semipublic
  #
  # source://mongo//lib/mongo/protocol/update.rb#87
  def upconverter; end
end
...
# @api semipublic
#
# source://mongo//lib/mongo/protocol/update.rb#98
...
# @since 2.5.0
#
# source://mongo//lib/mongo/protocol/update.rb#95
...
# @since 2.1.0
#
# source://mongo//lib/mongo/protocol/update.rb#123
class Mongo::Protocol::Update::Upconverter
  ...
  # @param flags [Array<Symbol>] The flags.
  # @param update [Hash] The update.
  # @param collection [String] The name of the collection.
  # @return [Upconverter] a new instance of Upconverter
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#178
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#151
  def collection; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#193
  def command; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#154
  def filter; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#160
  def flags; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/protocol/update.rb#157
  def update; end
end
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/update.rb#128
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/update.rb#133
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/update.rb#138
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/update.rb#143
...
# @since 2.2.0
#
# source://mongo//lib/mongo/protocol/update.rb#148
...
# @since 2.1.0
#
# source://mongo//lib/mongo/retryable.rb#23
module Mongo::Retryable
  ...
  #
  # source://mongo//lib/mongo/retryable.rb#334
  ...
  # @yieldparam context [Operation::Context] The operation context.
  #
  # source://mongo//lib/mongo/retryable.rb#299
  ...
  #
  # source://mongo//lib/mongo/retryable.rb#164
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#109
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#62
  ...
  # @yieldparam context [Operation::Context] The operation context.
  #
  # source://mongo//lib/mongo/retryable.rb#208
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#388
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#525
  def log_retry(e, options = T.unsafe(nil)); end

  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#367
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#536
  def raise_unsupported_error(e); end

  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#435
  def retry_read(original_error, server_selector, session, &block); end

  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#470
  def retry_write(original_error, txn_num, context:, &block); end

  # @return [Boolean]
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#420
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/retryable.rb#520
...
class Mongo::Server
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#62
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#236
  def ==(other); end

  # @return [String] The configured address for the server.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#97
  def address; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#172
  def compressor; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server.rb#252
  def connectable?; end
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server.rb#295
  def connected?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#114
  def description; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#266
  def disconnect!; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#121
  ...
  # @since 2.3.0
  #
  # source://mongo//lib/mongo/server.rb#478
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server.rb#455
  def handle_handshake_failure!; end

  # @deprecated
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#150
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server.rb#129
  def last_scan; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#140
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#415
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#104
  def monitor; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#110
  def monitoring; end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#614
  def next_connection_id; end

  # @return [Hash] The options hash.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#107
  def options; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#399
  def pool; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#315
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server.rb#429
  def reconnect!; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#500
  def retry_reads?; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/server.rb#521
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#224
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#220
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#305
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#337
  def status; end
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server.rb#368
  def summary; end
  ...
  #
  # source://mongo//lib/mongo/server.rb#549
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server.rb#619
  ...
  # @since 2.3.0
  #
  # source://mongo//lib/mongo/server.rb#447
...
# @since 2.4.0
#
# source://mongo//lib/mongo/server/app_metadata.rb#26
class Mongo::Server::AppMetadata
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#88
  def initialize(options = T.unsafe(nil)); end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#110
  def purpose; end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#120
  def server_api; end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#137
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#124
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#235
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#174
  def document; end

  # @api private
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#203
  def driver_doc; end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#159
  def full_client_document; end

  # @api private
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#231
  def name; end

  # @api private
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#218
  def os_doc; end

  # @api private
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#239
  def platform; end

  # @api private
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#226
  def type; end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/app_metadata.rb#148
  def validate!; end
end
...
# @since 2.4.0
#
# source://mongo//lib/mongo/server/app_metadata.rb#47
...
# @since 2.4.0
#
# source://mongo//lib/mongo/server/app_metadata.rb#42
...
# @since 2.4.0
#
# source://mongo//lib/mongo/server/app_metadata.rb#32
...
# @since 2.4.0
#
# source://mongo//lib/mongo/server/app_metadata.rb#52
...
class Mongo::Server::Connection < ::Mongo::Server::ConnectionBase
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#103
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection.rb#155
  def closed?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#203
  def connect!; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#143
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#275
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#160
  def error?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#137
  def global_id; end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection.rb#133
  def id; end

  # @return [Time] The last time the connection was checked back into a pool.
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/server/connection.rb#127
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#179
  def pin; end
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server/connection.rb#319
  def ping; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#172
  def pinned?; end
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/server/connection.rb#349
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#335
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#356
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#240
  def do_connect; end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection.rb#362
...
class Mongo::Server::ConnectionPool
  ...
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#83
  def initialize(server, options = T.unsafe(nil)); end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#230
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#463
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#282
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#536
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#602
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#243
  def closed?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#643
  def inspect; end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#188
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#160
  def max_size; end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#169
  def min_size; end
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#150
  def options; end
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#736
  def populate; end
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#262
  def populator; end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#208
  def size; end
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#708
  ...
  # @since 2.11.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#251
  def summary; end
  ...
  # @since 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#178
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#663
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#877
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#861
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#816
  def create_and_add_connection; end

  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#799
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#785
  def next_available_connection(connection_global_id: T.unsafe(nil)); end
  ...
  # @since 2.0.0, largely rewritten in 2.9.0
  #
  # source://mongo//lib/mongo/server/connection_pool.rb#220
  ...
  class << self
    ...
    # @since 2.0.0, largely rewritten in 2.9.0
    #
    # source://mongo//lib/mongo/server/connection_pool.rb#762
...
# @since 2.9.0
#
# source://mongo//lib/mongo/server/connection_pool.rb#51
...
class Mongo::Server::ConnectionPool::GenerationManager
  ...
  # @api private
  #
  # source://mongo//lib/mongo/server/connection_pool/generation_manager.rb#48
  ...
  # @api private
  #
  # source://mongo//lib/mongo/server/connection_pool/generation_manager.rb#31
  def server; end
end
...
class Mongo::Server::Description
  ...
  # @since 2.0.6
  #
  # source://mongo//lib/mongo/server/description.rb#862
  def ==(other); end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#318
  def arbiter?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#332
  def arbiters; end

  # @return [Float] The moving average time the hello call took to complete.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#308
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server/description.rb#794
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server/description.rb#480
  def election_id; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#344
  def ghost?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#357
  def hidden?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#369
  def hosts; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#381
  def inspect; end
  ...
  # @since 2.0.6
  #
  # source://mongo//lib/mongo/server/description.rb#756
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#840
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server/description.rb#831
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/description.rb#545
  ...
  # @since 2.0.6
  #
  # source://mongo//lib/mongo/server/description.rb#770
  ...
  # @since 2.5.0
  #
  # source://mongo//lib/mongo/server/description.rb#557
  def logical_session_timeout; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#393
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#405
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#429
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#417
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server/description.rb#456
  def me; end
  ...
  # @since 2.0.6
  #
  # source://mongo//lib/mongo/server/description.rb#806
  def me_mismatch?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#441
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#569
  def mongos?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#730
  def ok?; end
  ...
  # @since 2.7.0
  #
  # source://mongo//lib/mongo/server/description.rb#815
  def op_time; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#581
  def other?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#600
  def passive?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#612
  def passives; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#636
  def primary?; end
  ...
  # @since 2.6.0
  #
  # source://mongo//lib/mongo/server/description.rb#624
  ...
  # @since 2.0.6
  #
  # source://mongo//lib/mongo/server/description.rb#783
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#651
  def replica_set_name; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#675
  def secondary?; end

  # @api experimental
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#843
  def server_connection_id; end
  ...
  # @since 2.4.0
  #
  # source://mongo//lib/mongo/server/description.rb#689
  def server_type; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#873
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#663
  def servers; end

  # @api experimental
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#848
  def service_id; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#709
  def standalone?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#468
  def tags; end

  # @return [TopologyVersion | nil] The topology version.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#497
  def topology_version; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#513
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#529
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#724
  def unknown?; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/description.rb#743
...
class Mongo::Server::Monitor
  ...
  # @since 2.1.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#263
  def restart!; end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#232
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#271
  def to_s; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#297
  def check; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#277
  def pre_stop; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server/monitor.rb#341
...
# @api private
#
# source://mongo//lib/mongo/server/connection_pool/populator.rb#24
class Mongo::Server::Populator
  ...
  #
  # source://mongo//lib/mongo/server/connection_pool/populator.rb#31
  def initialize(pool, options = T.unsafe(nil)); end

  # @api private
  #
  # source://mongo//lib/mongo/server/connection_pool/populator.rb#37
  def options; end

  # @api private
  #
  # source://mongo//lib/mongo/server/connection_pool/populator.rb#39
  def pre_stop; end
  ...
  # @api private
  #
  # source://mongo//lib/mongo/server/connection_pool/populator.rb#45
  def do_work; end
end
...
class Mongo::ServerSelector::Base
  ...
  # @return [Array<Server>] The candidate servers.
  #
  # source://mongo//lib/mongo/server_selector/base.rb#358
  ...
  #
  # source://mongo//lib/mongo/server_selector/base.rb#382
  ...
  #
  # source://mongo//lib/mongo/server_selector/base.rb#307
  def try_select_server(cluster, write_aggregation: T.unsafe(nil)); end

  private

  # source://mongo//lib/mongo/server_selector/base.rb#509
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server_selector/base.rb#406
  def full_doc; end
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server_selector/base.rb#500
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server_selector/base.rb#460
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/server_selector/base.rb#424
  ...
  #
  # source://mongo//lib/mongo/server_selector/base.rb#632
  def server_selection_diagnostic_message(cluster); end

  # source://mongo//lib/mongo/server_selector/base.rb#534
  def validate!; end

  # source://mongo//lib/mongo/server_selector/base.rb#556
  def validate_max_staleness_support!(server); end

  # source://mongo//lib/mongo/server_selector/base.rb#572
  def validate_max_staleness_value!(cluster); end

  # source://mongo//lib/mongo/server_selector/base.rb#562
...
class Mongo::Socket
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#364
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#383
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#455
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#368
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#417
  def set_keepalive_opts(sock); end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#429
  def set_option(sock, option, default); end

  # @api private
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/socket.rb#438
...
class Mongo::Srv::Monitor
  ...
  # @api private
  #
  # source://mongo//lib/mongo/srv/monitor.rb#98
  def scan_interval; end

  # @api private
  #
  # source://mongo//lib/mongo/srv/monitor.rb#108
  def timeout; end
end
...
class Mongo::URI
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#457
  def decode(value); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#461
  def encode(value); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#385
  def extract_db_opts!(string); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#394
  ...
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#431
  def parse_password!(string); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#400
  def parse_uri_options!(string); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#420
  def parse_user!(string); end

  # @raise [Error::InvalidURI]
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#449
  def raise_invalid_error!(details); end

  # @raise [Error::InvalidURI]
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#453
  def raise_invalid_error_no_fmt!(details); end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#333
  def scheme; end

  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri.rb#465
...
class Mongo::URI::OptionsMapper
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#131
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#177
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#417
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#431
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#454
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#296
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#356
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#334
  ...
  #   (and a warning will be logged).
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#478
  ...
  # @api private
  # @param name [String] Name of the URI option being processed.
  # @param value [Integer] The millisecond value.
  # @return [Float] The seconds value.
  # @since 2.0.0
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#379
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#508
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#541
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#522
  ...
  #   in an array.
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#319
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#403
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#582
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#605
  ...
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#196
  ...
  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#437
  def revert_auth_mech(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#466
  def revert_auth_mech_props(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#308
  def revert_bool(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#365
  def revert_integer(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#344
  def revert_inverse_bool(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#498
  def revert_max_staleness(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#393
  def revert_ms(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#512
  def revert_read_mode(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#531
  def revert_read_tags(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#323
  def revert_repeated_bool(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#407
  def revert_symbol(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#566
  def revert_w(value); end

  # @api private
  #
  # source://mongo//lib/mongo/uri/options_mapper.rb#595
  ...
  class << self
    ...
    #
    # source://mongo//lib/mongo/uri/options_mapper.rb#222
...
#   option names.
#
# source://mongo//lib/mongo/uri/options_mapper.rb#213
...
# @api private
#
# source://mongo//lib/mongo/uri/options_mapper.rb#209
...
# @since 2.0.0
#
# source://mongo//lib/mongo/write_concern/acknowledged.rb#33
...
# @since 2.0.0
#
# source://mongo//lib/mongo/write_concern/unacknowledged.rb#28
