...
module TTY::Which
  ...
  # @return [Boolean]
  #
  # source://tty-which//lib/tty/which.rb#126
  def executable_file?(filename, dir = T.unsafe(nil)); end

  # Check if executable exists in the path
  #
  # @api public
  # @param command [String] the executable to check
  # @param paths [String] paths to check
  # @return [Boolean]
  #
  # source://tty-which//lib/tty/which.rb#62
  ...
  #
  # source://tty-which//lib/tty/which.rb#103
  ...
  # @return [Boolean]
  #
  # source://tty-which//lib/tty/which.rb#145
  ...
  # @return [Boolean]
  #
  # source://tty-which//lib/tty/which.rb#160
  ...
  #
  # source://tty-which//lib/tty/which.rb#80
  ...
  # @param command [String] the command to search for
