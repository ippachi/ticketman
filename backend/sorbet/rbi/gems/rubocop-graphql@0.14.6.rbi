...
class RuboCop::Cop::GraphQL::FieldDefinitions < ::RuboCop::Cop::Base
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#72
  def on_class(node); end
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#116
  def check_resolver_is_defined_after_definition(field); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#157
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#188
  def insert_new_resolver(corrector, field_definition, resolver_definition); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#133
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#197
  def remove_old_resolver(corrector, resolver_definition); end

  # @return [Boolean]
  #
  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#137
  def resolver_defined_after_definition?(field, method_definition); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#213
  def signature_to_insert(node); end
end

# source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#84
RuboCop::Cop::GraphQL::FieldDefinitions::GROUP_DEFS_MSG = T.let(T.unsafe(nil), String)

# source://rubocop-graphql//lib/rubocop/cop/graphql/field_definitions.rb#112
