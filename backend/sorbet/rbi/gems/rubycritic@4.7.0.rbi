...
module RubyCritic::Config
  class << self
    ...
    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#58
    def compare_branches_mode?; end

    # source://rubycritic//lib/rubycritic/configuration.rb#50
    def configuration; end

    # source://rubycritic//lib/rubycritic/configuration.rb#66
    def method_missing(method, *args, &block); end

    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#74
    def respond_to_missing?(symbol, include_all = T.unsafe(nil)); end

    # source://rubycritic//lib/rubycritic/configuration.rb#54
...
class RubyCritic::Configuration
  ...
  # source://rubycritic//lib/rubycritic/configuration.rb#27
  def setup_version_control(options); end

  # @return [Boolean]
  #
  # source://rubycritic//lib/rubycritic/configuration.rb#43
...
class RubyCritic::SourceControlSystem::Git < ::RubyCritic::SourceControlSystem::Base
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#89
  def stash_changes; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#96
  def stashes_count; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#100
...
class RubyCritic::SourceControlSystem::Git::Churn
  ...
  def initialize(churn_after: T.unsafe(nil)); end
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#51
  def git_log_command; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#69
  def process_date(date); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#78
  def process_file(filename); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#56
  def process_line(line); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#73
  def process_rename(from, to); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#82
  def record_commit(filename, date); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#87
  def stats(path); end
end
